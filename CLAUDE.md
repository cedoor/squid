...
| File | Contents |
|---|---|
| [project.mdc](.cursor/rules/project.mdc) | Project purpose, current scope, public API surface |
| [modules.mdc](.cursor/rules/modules.mdc) | Module responsibilities and ownership model |
